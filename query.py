...
def get_team_season_stats(team, season):
    ...
    msg = "{} season stats: {}-{}-{}, {}-{}-{}, {}-{}-{}, {}-{}-{}".format(team, 'Points Per Game', PPG, PPGth, 'Rebounds Per Game', RPG, RPGth, 'Assists Per Game', APG, APGth, 'Points Allowed', PA, PAth)

    return msg

# given contextframe and number of type of question
def query(question,ContextFrame):
